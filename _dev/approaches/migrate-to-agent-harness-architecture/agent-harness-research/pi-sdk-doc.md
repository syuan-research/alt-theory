...
See [examples/sdk/](pi-sdk-examples-readme.md) for working examples from minimal to full control.
...
> See [examples/sdk/02-custom-model.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/02-custom-model.ts)
...
> See [examples/sdk/09-api-keys-and-oauth.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/09-api-keys-and-oauth.ts)
...
> See [examples/sdk/03-custom-prompt.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/03-custom-prompt.ts)
...
> See [examples/sdk/05-tools.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/05-tools.ts)
...
> See [examples/sdk/06-extensions.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/06-extensions.ts) and [docs/extensions.md](extensions.md)
...
> See [examples/sdk/04-skills.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/04-skills.ts)
...
> See [examples/sdk/07-context-files.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/07-context-files.ts)
...
> See [examples/sdk/08-prompt-templates.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/08-prompt-templates.ts)
...
> See [examples/sdk/11-sessions.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/11-sessions.ts) and [docs/session.md](session.md)
...
> See [examples/sdk/10-settings.ts](https://github.com/badlogic/pi-mono/blob/main/packages/coding-agent/examples/sdk/10-settings.ts)
...
JSON-RPC mode for subprocess integration. See [rpc.md](rpc.md) for the JSON protocol.
