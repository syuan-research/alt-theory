...
- `development/architecture/repo-structure-v0.3.md` defines the current public
  repository layout and the roles of `alt-theory-app/`, `agent-assets/`,
  `docs/`, and `development/`.
- `AGENTS.md` defines the current public contributor and agent guardrails.
- Private development evidence and process records are maintained outside this
  repository; selected durable engineering evidence remains under
  `development/`.
