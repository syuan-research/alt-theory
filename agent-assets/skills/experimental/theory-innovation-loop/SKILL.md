...
description: Diverge–converge loop for theory innovation — propose multi-candidate concept/mechanism maps, inductive/deductive rounds, and gated subagent batches when the user needs more than a short list of options. Use when the user wants many mechanisms/concepts, possibility maps, multi-stage theory work, or stalled candidates; or asks for 理论创新 / 发散收敛 / 归纳演绎 loop / theory-innovation-loop. Experimental — not a v1 commitment.
category: research
---
