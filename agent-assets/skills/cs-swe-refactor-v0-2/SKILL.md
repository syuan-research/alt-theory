...
单函数 / 单组件 / 1-3 处优化 / 有测试可自证 / 不需要目视——走完整三阶段太重。触发 `cs-swe-refactor-ff-v0-2`：直接识别、一次对齐、原地改、跑测试自证，不产 scan / design / checklist。
...
```
project/workstreams/swe/refactors/{YYYY-MM-DD}-{slug}/
...
- `cs-swe-refactor-ff-v0-2/SKILL.md` — 小重构超轻量通道
...
- `agent-assets/skills/cs-swe-v0-2/references/shared-conventions.md` — 跨工作流共享口径
