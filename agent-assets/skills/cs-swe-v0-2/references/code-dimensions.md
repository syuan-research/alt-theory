...
这份文档是 CodeStable 子技能共享的口径，被 design / fastforward / issue-fix 等阶段引用。项目内的权威副本在 `agent-assets/skills/cs-swe-v0-2/references/code-dimensions.md`，由 `CS-SWE startup setup` 从技能包释放。
