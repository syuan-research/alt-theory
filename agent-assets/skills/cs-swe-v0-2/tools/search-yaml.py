...
Usage examples:
  ...
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir project/workstreams/swe/compound --filter "doc_type=decision|explore|learning"
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir project/workstreams/swe/compound --filter doc_type=trick --filter tags~=prisma
  ...
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir project/workstreams/swe/compound --filter doc_type=learning --filter track=knowledge --json

  # Sort by a frontmatter date field (works on any ISO-8601 date string, YAML date, or sortable value)
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir project/workstreams/swe/library-docs-deferred --sort-by last_reviewed --order asc   # oldest first (stalest)
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir project/workstreams/swe/compound --sort-by date --order desc              # newest first

  # Works on any yaml-frontmatter markdown directory
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir docs/decisions --filter status=accepted
  python agent-assets/skills/cs-swe-v0-2/tools/search-yaml.py --dir content/posts --filter tags~=python --query "asyncio"
"""
