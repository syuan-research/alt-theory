...
Usage examples:
  ...
  python {skill_dir}/tools/validate-yaml.py --file project/workstreams/swe/features/2026-04-11-auth/auth-design.md

  # Check that required fields exist in frontmatter
  python {skill_dir}/tools/validate-yaml.py --dir project/workstreams/swe/features --require doc_type --require status
