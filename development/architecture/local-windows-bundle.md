# Historical Local Windows Bundle
...
The former v0.5 folder/portable analysis remains available in Git history. It
must not select the current build command or distribution format.
