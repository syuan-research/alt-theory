...
Target version: v0.5.x local bundle / `win-unpacked` folder build.

## What You Should Receive

You should receive a zip file containing the whole `win-unpacked` folder. Unzip it first, then run:
