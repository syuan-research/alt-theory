...
Usage examples:
  ...
  python {skill_dir}/tools/validate-yaml.py --dir project/workstreams/0-backend-agent-harness/swe/features

  # Validate a single file
  python {skill_dir}/tools/validate-yaml.py --file project/workstreams/0-backend-agent-harness/swe/features/2026-06-07-session-persistence-and-output-folders/session-persistence-and-output-folders-design.md

  # Check that required fields exist in frontmatter
  python {skill_dir}/tools/validate-yaml.py --dir project/workstreams/0-backend-agent-harness/swe/features --require doc_type --require status

  # JSON output for programmatic consumption
  python {skill_dir}/tools/validate-yaml.py --dir docs/api --json

  # Validate the libdoc manifest
  python {skill_dir}/tools/validate-yaml.py --file docs/api/manifest.yaml --yaml-only
"""
