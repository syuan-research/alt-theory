...
Usage examples:
  ...
  python {skill_dir}/tools/search-yaml.py --dir project/brainstorms --filter doc_type=brainstorm --sort-by created --order desc
  ...
  python {skill_dir}/tools/search-yaml.py --dir content/posts --filter tags~=python --query "asyncio"
"""
